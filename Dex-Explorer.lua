...
local ServicesMt = {
  ...
  local function main()
    ...
    Explorer.InitRightClick = function()
      ...
      local OldAnimation
      context:Register("LOAD_ANIMATION",{Name = "Play Animation", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
        local sList = selection.List
      ...
      context:Register("GET_REFERENCES",{Name = "View Lua References", IconMap = Explorer.ClassIcons, Icon = 34, OnClick = function()
      ...
      --[[context:Register("VIEW_CONNECTIONS",{Name = "ดู Connections", OnClick = function()
        
      end})]]
      
      context:Register("VIEW_API",{Name = "View API", IconMap = Explorer.MiscIcons, Icon = "Reference", OnClick = function()
      ...
      context:Register("FIRE_TOUCHTRANSMITTER",{Name = "Shoot TouchTransmitter", IconMap = Explorer.ClassIcons, Icon = 37, OnClick = function()
      ...
      context:Register("FIRE_CLICKDETECTOR",{Name = "Shoot ClickDetector", IconMap = Explorer.ClassIcons, Icon = 41, OnClick = function()
        local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
        if not hrp then return end
        for _, v in ipairs(selection.List) do if v.Obj and v.Obj:IsA("ClickDetector") then fireclickdetector(v.Obj) end end
      end})
  
      context:Register("FIRE_PROXIMITYPROMPT",{Name = "Shoot ProximityPrompt", IconMap = Explorer.ClassIcons, Icon = 124, OnClick = function()
        local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
        if not hrp then return end
      ...
      context:Register("SAVE_BYTECODE",{Name = "Save ScriptBytecode to a file", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
      ...
      context:Register("VIEW_PLAYER",{Name = "Watch the players", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
        local newSelection = {}
        local count = 1
        local sList = selection.List
        local isa = game.IsA
    ...
    Explorer.Init = function()
      ...
      local explorerItems = create({
        ...
        {4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="ค้นหาไฟล์ที่ต้องการ",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
  ...
  local function main()
    ...
    Properties.DisplayAddAttributeWindow = function(editAttr)
      ...
      win:SetTitle(editAttr and "Edit Attribute "..editAttr.AttributeName or "เพิ่ม Attribute")
    ...
    Properties.InitEntryStuff = function()
      Properties.EntryTemplate = create({
        ...
        {26,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderSizePixel=0,Font=3,Name="RowButton",Parent={1},Size=UDim2.new(1,0,1,0),Text="เพิ่ม Attribute",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,Visible=false,}},
      })
    ...
    Properties.Init = function() -- TODO: MAKE BETTER
      local guiItems = create({
        ...
        {2,"Frame",{BackgroundColor3=Color3.new(0.20392157137394,0.20392157137394,0.20392157137394),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
        {3,"Frame",{BackgroundColor3=Color3.new(0.14901961386204,0.14901961386204,0.14901961386204),BorderColor3=Color3.new(0.1176470592618,0.1176470592618,0.1176470592618),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
        {4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="ค้นหาข้อมูลไฟล์",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
        {5,"UICorner",{CornerRadius=UDim.new(0,2),Parent={3},}},
        {6,"UIStroke",{Thickness=1.4,Parent={3},Color=Color3.fromRGB(42,42,42)}},
        {7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.12549020349979,0.12549020349979,0.12549020349979),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Reset",Parent={3},Position=UDim2.new(1,-17,0,1),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
        {8,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://5034718129",ImageColor3=Color3.new(0.39215686917305,0.39215686917305,0.39215686917305),Parent={7},Size=UDim2.new(0,16,0,16),}},
  ...
  Main = (function()
    ...
    Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
      local gui = create({
        ...
        {5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Hello " .. (game:GetService("Players").LocalPlayer.DisplayName or "User"),TextColor3=Color3.new(1,1,1),TextSize=20,TextTransparency=1,}},
        {6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="My sword strikes with precision.",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
        {7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="One glance is enough to see who’s the best.",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=1,}},
        ...
        {11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Lego: dsc.gg/lego-lua",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
    ...
    Main.SetMainGuiOpen = function(val)
      ...
      Main.MainGui.OpenButton.Text = val and "❌" or "⚙️"
    ...
    Main.CreateMainGui = function()
      ...
      -- Create Main Apps
      Main.CreateApp({Name = "File Explorer", IconMap = Main.LargeIcons, Icon = "Explorer", Open = true, Window = Explorer.Window})
      
      Main.CreateApp({Name = "File Properties", IconMap = Main.LargeIcons, Icon = "Properties", Open = true, Window = Properties.Window})
      
      Main.CreateApp({Name = "Script Reader", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})
      
      local cptsOnMouseClick = nil
      Main.CreateApp({Name = "Click to choose", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
        if callback then
          local mouse = Main.Mouse
    ...
    Main.Init = function()
      ...
      intro.SetProgress("Wait a moment, loading the roblox version.",0.2)
      if Main.Elevated then
      ...
      -- Fetch external deps
      intro.SetProgress("Load the API for a moment.",0.35)
      API = Main.FetchAPI()
      Lib.FastWait()
      intro.SetProgress("Load RMD for a moment.",0.5)
      RMD = Main.FetchRMD()
      Lib.FastWait()
      ...
      -- Init other modules
      intro.SetProgress("Preparing Modules",0.9)
      Explorer.Init()
      Properties.Init()
      ScriptViewer.Init()
      Lib.FastWait()
      ...
      -- Done
      intro.SetProgress("It's done, damn it.",1)
      coroutine.wrap(function()
        Lib.FastWait(1.25)
        intro.Close()
      end)()
